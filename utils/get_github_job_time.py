...
def extract_time_from_single_job(job, caller_job_name=None):
    ...
    job_info["caller_job_name"] = caller_job_name
    return job_info


def get_job_time(workflow_run_id, token=None, caller_job_name=None):
